...
import { addCard, createColumn, getColumn,addLablesCard,getCardData } from '../controller/Column.js';
...
boardRouter.post('/addcards/label/:cardId',authMiddleware,addLablesCard);
